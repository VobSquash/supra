...
import 'package:middleware/middleware.dart' as _i1070;
...
_i174.GetIt initAppBloc(
  ...
  gh.factory<_i57.LocationsBloc>(
    () => _i57.LocationsBloc(gh<_i1070.ILocationsFacade>()),
  );
  gh.factory<_i407.LeagueFixturesBloc>(
    () => _i407.LeagueFixturesBloc(gh<_i1070.ILeagueFixturesFacade>()),
  );
  gh.factory<_i1037.BookingsBloc>(
    () => _i1037.BookingsBloc(gh<_i1070.IBookingsFacade>()),
  );
  gh.factory<_i558.LaddersBloc>(
    () => _i558.LaddersBloc(gh<_i1070.ILaddersFacade>()),
  );
  gh.factory<_i287.SettingsBloc>(
    () => _i287.SettingsBloc(gh<_i1070.ISettingsFacade>()),
  );
  gh.factory<_i48.UsersBloc>(() => _i48.UsersBloc(gh<_i1070.IUsersFacade>()));
  return getIt;
}
