...
import 'package:dupra/presentation/calculator/widgets/saved_item_card.dart';
import 'package:flutter/material.dart';

class SavedItemsDialog extends StatelessWidget {
  const SavedItemsDialog({required this.categorizedItems, required this.timestamp, required this.username, super.key});
  ...
  Widget build(BuildContext context) {
            ...
            children: [
              Padding(
                ...
                child: Text(
                  ...
                  style: Theme.of(
                    context,
                  ).textTheme.labelLarge?.copyWith(letterSpacing: 0.6, fontWeight: FontWeight.w800),
                ),
              ),
              ...itemWidgets,
            ],
    ...
    final formattedTime = '${savedTime.hour.toString().padLeft(2, '0')}:${savedTime.minute.toString().padLeft(2, '0')}';
    ...
    return AlertDialog(
      title: Column(
        ...
        children: [
          ...
          Text('Last saved: $formattedDate at $formattedTime', style: Theme.of(context).textTheme.bodyMedium),
          if (username.isNotEmpty) Text('For: $username', style: Theme.of(context).textTheme.bodyMedium),
        ],
      ),
      content: SizedBox(
