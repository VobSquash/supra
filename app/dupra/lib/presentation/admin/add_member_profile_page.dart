...
/// Full-screen admin flow: insert profiles + extensions via [UsersBloc].
///
/// Push with [Navigator.push] and wrap with
/// `BlocProvider<UsersBloc>.value(value: context.read<UsersBloc>(), child: const AddMemberProfilePage())`.
