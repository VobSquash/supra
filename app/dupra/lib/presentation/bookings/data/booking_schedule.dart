...
/// Maps DB/API court number to grid columns 1–3 (supports 0-based 0,1,2).
...
/// from DB — see same-calendar-day matching above).
///
...
int? slotStartForWallClock(int hour, int minute) {
  ...
  const lastWindowEnd = CourtSchedule.lastSlotStartMinutes + CourtSchedule.slotDurationMinutes;
...
///
/// The booking date is interpreted using **UTC wall-clock** hour/minute and UTC calendar
